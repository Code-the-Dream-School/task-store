...
const { logon, githubAuth, githubCallback, logoff, newOrigin, createOrigin } = require("../controllers/originController.js")
...
router.route("/addOrigin").get(checkAuth, newOrigin).post(checkAuth,createOrigin)
